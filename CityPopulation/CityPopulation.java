...
public class CityPopulation {
	public static void main(String[] args) {
		...
		System.out.println("City with less area is " + "" + lessArea.cityname + " with area " + lessArea.area_of_city);
		...
		System.out.println("City with high pollution index is " + "" + highPollutionInd.cityname
				+ " with pollution index " + highPollutionInd.pollutionIndex);

		// for high city area
		City highcityArea = list.stream().max(comparator2).get();
		System.out.println("City with high city area is " + "" + highcityArea.cityname + " with area "
				+ highcityArea.area_of_city);
		...
		System.out.println("City with lowest pollution index is " + "" + lowPollutionInd.cityname
				+ " with pollution index " + lowPollutionInd.pollutionIndex);
		// for lowest area of city.
		City lowcityArea = list.stream().min(comparator2).get();
		System.out.println(
				"City with low city area is " + "" + lowcityArea.cityname + " with area " + lowcityArea.area_of_city);
